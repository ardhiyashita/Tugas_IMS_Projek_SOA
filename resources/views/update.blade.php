    ...
    <section class="py-5">
        <div class="box-movie">
            ...
            <div class="white-line mb-3"></div>
                <form action="{{ route('save-update-film', $film->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="box-movie-info">

                    <div class="container">
                        <img class="img-movie mb-3" src="/{{ $film->foto }}" alt="">
                        <input type="file" id="img" value="{{ $film->foto }}" name="img" class="form-control" style="width: 400px;">
                    </div>
                    <div class="box-empat" style="text-align: left; padding: 10px; box-shadow:none;">
                        <div class="form-group mb-3">
                            <label for="exampleFormControlSelect1" class="roboto-merah">Name of Movie</label>
                                <input type="text" value="{{ $film->nama_film }}" name="nama" class="form-control ps-0 form-control-line" placeholder="   ex: Avatar:The Legend of Aang">
                        </div>
                        <div class="form-group mb-3">
                            <label for="exampleFormControlSelect1" class="roboto-merah">Release Date</label>  
                                <input type="date" value="{{ $film->tanggal }}" name="tanggal" class="form-control ps-0 form-control-line" placeholder="   ex: 22 January 2021">
                        </div>
                        <div class="form-group mb-3">
                            <label for="exampleFormControlSelect1" class="roboto-merah">Rating</label>
                                <input type="number" value="{{ $film->rating }}" name="rating" class="form-control ps-0 form-control-line" placeholder="   ex: 9">
                        </div>
                        <div class="form-group mb-3">
                            <label for="exampleFormControlSelect1" class="roboto-merah">Description</label>
                                <textarea name="deskripsi" class="form-control ps-0 form-control-line" placeholder="ex: Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea.">{{ $film->deskripsi }}</textarea>
